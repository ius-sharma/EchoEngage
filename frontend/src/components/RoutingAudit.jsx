...
export default function RoutingAudit({ decision, analytics }) {
  ...
  return (
    <div className="content-card routing-card">
      ...
      <div className="content-card-body p-5">
        {/* Current Decision */}
        {decision && (
        <div className="space-y-4 mb-5 animate-fade-in">
          ...
          {decision.reason && (
            <div className="text-[11px] text-gray-500 bg-white/[0.02] rounded-lg p-3 border border-white/5 leading-relaxed">
      ...
      {analytics && (
        <div className={`${decision ? 'border-t border-white/5 pt-5' : ''}`}>
          <div className="text-[11px] text-gray-500 font-semibold mb-3 uppercase tracking-wider">Session Statistics</div>
          <div className="space-y-3">
            ...
            <div className="flex justify-between text-xs border-t border-white/5 pt-3 mt-3">
